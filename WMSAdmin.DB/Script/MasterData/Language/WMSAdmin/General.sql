...
select @TimeStamp,@LanguageCultureSwedish,@LanguageGroupId,'UpdateServerData','Uppdatera serverdata' union 

select @TimeStamp,@LanguageCultureEnglish,@LanguageGroupId,'MyProfile','My Profile' union
select @TimeStamp,@LanguageCultureSwedish,@LanguageGroupId,'MyProfile','Min profil' 
